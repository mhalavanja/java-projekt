...
public class Grid extends JPanel implements ActionListener {
    ...
    public List<Vertex> getStartEndCells() {
        return startEndCells;
    }

    public List<Vertex> getOpenedCells() {
        return openedCells;
    }

    public List<Vertex> getVisitedCells() {
        return visitedCells;
    }

    public List<Vertex> getWallCells() {
        return wallCells;
    }
    ...
    public String toString() {
        return "start = " + startEndCells.get(0) +
                " end = " + startEndCells.get(1) +
                ", opened = " + openedCells +
